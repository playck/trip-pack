...
import { useDeleteShoppingItem } from "../../list/hooks/useShoppingMutations";

interface ShoppingItemActionsSheetProps {
  isOpen: boolean;
  itemId: string;
  itemName: string;
  tripId?: string;
...
export default function ShoppingItemActionsSheet({
  isOpen,
  itemId,
  itemName,
  tripId,
  ...
  const deleteItemMutation = useDeleteShoppingItem(tripId, {
    onSuccess: () => {
      onDeleteModalClose();
      onClose();
    },
