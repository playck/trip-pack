...
import { useDeleteTodoItem } from "../../list/hooks/useTodoMutations";

interface TodoItemActionsSheetProps {
  isOpen: boolean;
  itemId: string;
  itemName: string;
  tripId?: string;
...
export default function TodoItemActionsSheet({
  isOpen,
  itemId,
  itemName,
  tripId,
  ...
  const deleteItemMutation = useDeleteTodoItem(tripId, {
    onSuccess: () => {
      onDeleteModalClose();
      onClose();
    },
